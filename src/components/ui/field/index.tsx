...
interface Props extends Omit<StackProps, 'component' | 'direction'>, PropsWithChildren {
	label: string
...
const FieldContent = ({ label, children, direction, showColon }: Omit<Props, 'component'>) => {
	return (
