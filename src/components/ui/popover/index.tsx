...
export const usePopover = () => useRef<PopoverOptions>(null) as RefObject<PopoverOptions>

export const openPopover = (ref: React.RefObject<PopoverOptions> | null) => (element: HTMLElement) =>
